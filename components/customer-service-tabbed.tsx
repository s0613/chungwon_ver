  ...
  const faqData = [
    {
      ...
      answer:
        "제품 주문은 전화(032-818-4168) 또는 인스타그램 DM으로 문의해 주시면 됩니다. 상담 후 주문을 도와드리겠습니다.",
    },
    {
      question: "배송은 얼마나 걸리나요?",
      answer:
        "일반적으로 주문 후 1-2일 내에 배송되며, 지역에 따라 1-3일 정도 소요됩니다. 급한 경우 별도 문의해 주세요.",
    },
    {
      question: "제품의 유통기한은 어떻게 되나요?",
      answer:
        "모든 제품은 엄격한 품질관리를 통해 제조되며, 유통기한은 제품별로 다릅니다. 구체적인 유통기한은 제품 상세페이지에서 확인하실 수 있습니다.",
    },
    {
      question: "반품/교환이 가능한가요?",
      answer:
        "제품 하자 시에는 즉시 교환/반품을 도와드립니다. 단순 변심의 경우에는 배송비를 부담해 주셔야 합니다.",
    },
    {
      question: "대량 주문도 가능한가요?",
      answer:
        "네, 대량 주문도 가능합니다. 전화로 문의해 주시면 별도 가격과 배송 조건을 안내해 드리겠습니다.",
    },
  ];
    ...
    <section className="py-16 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">고객 지원</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            자주 묻는 질문과 소셜미디어를 통해 더 많은 정보를 얻어보세요
          </p>
        </div>

        {/* Tabs를 비제어로 사용: defaultValue만 설정 */}
        <Tabs defaultValue="faq" className="w-full">
          <TabsList className="grid w-full grid-cols-2 max-w-md mx-auto mb-8 bg-[#EFF2F5] rounded-full p-1 !h-full">
            <TabsTrigger
              value="faq"
                ...
                {snsData.map((sns, index) => (
                  <Card key={index} className="hover:shadow-lg transition-shadow duration-300">
                    <CardHeader className="text-center">
                      ...
                      <CardDescription className="text-base font-medium">{sns.handle}</CardDescription>
                    </CardHeader>
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <Card className="bg-white shadow-lg">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-lg">전화로 직접 상담받고 싶으시다면 언제든 연락해 주세요</CardDescription>
            </CardHeader>
            <CardContent className="text-center">
